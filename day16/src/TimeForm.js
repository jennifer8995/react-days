    ...
    render() {
        ...
        return (
            <form onSubmit={this._handleFormSubmit}>
                ...
                <input type="text" placeholder="A chronic string message (such as 7 hours from now)"
                    onChange={this._changeMsg}></input>
                <input type="submit" value="Update request"></input>
            </form>
        )
    }
}
